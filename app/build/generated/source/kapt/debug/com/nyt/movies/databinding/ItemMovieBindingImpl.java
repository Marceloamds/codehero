...
public class ItemMovieBindingImpl extends ItemMovieBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.constraint_layout_movie_preview, 2);
        sViewsWithIds.put(R.id.guideline_vertical, 3);
        sViewsWithIds.put(R.id.text_view_movie_title, 4);
        sViewsWithIds.put(R.id.text_view_movie_review, 5);
        sViewsWithIds.put(R.id.image_view_movie_poster, 6);
        sViewsWithIds.put(R.id.guideline, 7);
        sViewsWithIds.put(R.id.constraint_layout_movie_details, 8);
        sViewsWithIds.put(R.id.text_view_movie_title_end, 9);
