...
public class ActivityMoviesDetailsBindingImpl extends ActivityMoviesDetailsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.image_view_movie_poster, 2);
        sViewsWithIds.put(R.id.button_go_back, 3);
        sViewsWithIds.put(R.id.button_favorite, 4);
        sViewsWithIds.put(R.id.guideline, 5);
        sViewsWithIds.put(R.id.constraint_layout_movie_details, 6);
        sViewsWithIds.put(R.id.text_view_movie_title, 7);
    ...
    public ActivityMoviesDetailsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }
    private ActivityMoviesDetailsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
