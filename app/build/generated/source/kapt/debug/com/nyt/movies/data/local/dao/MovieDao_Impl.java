...
public final class MovieDao_Impl implements MovieDao {
  ...
  private final EntityDeletionOrUpdateAdapter<DbMovie> __updateAdapterOfDbMovie;
  ...
  public MovieDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfDbMovie = new EntityInsertionAdapter<DbMovie>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR IGNORE INTO `movie` (`link_url`,`display_title`,`critics_pick`,`byline`,`headline`,`summary_short`,`publication_date`,`opening_date`,`link_type`,`suggested_link_text`,`multimedia_type`,`multimedia_src`,`multimedia_width`,`multimedia_height`,`is_favorite`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfDbMovie = new EntityDeletionOrUpdateAdapter<DbMovie>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `movie` SET `link_url` = ?,`display_title` = ?,`critics_pick` = ?,`byline` = ?,`headline` = ?,`summary_short` = ?,`publication_date` = ?,`opening_date` = ?,`link_type` = ?,`suggested_link_text` = ?,`multimedia_type` = ?,`multimedia_src` = ?,`multimedia_width` = ?,`multimedia_height` = ?,`is_favorite` = ? WHERE `link_url` = ?";
      }
  ...
  @Override
  public Object insertMovies(final List<DbMovie> movies, final Continuation<? super Unit> p1) {
  ...
  @Override
  public Object updateMovie(final DbMovie movie, final Continuation<? super Unit> p1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
        try {
          __updateAdapterOfDbMovie.handle(movie);
          __db.setTransactionSuccessful();
          return Unit.INSTANCE;
        } finally {
          __db.endTransaction();
  ...
  @Override
  public Object getMovies(final int limit, final String query,
      final Continuation<? super List<DbMovie>> p2) {
    final String _sql = "SELECT * FROM movie WHERE display_title LIKE ? OR summary_short LIKE ? ORDER BY publication_date DESC LIMIT ?";
    ...
    return CoroutinesRoom.execute(__db, false, new Callable<List<DbMovie>>() {
      @Override
      public List<DbMovie> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new DbMovie(_tmpLinkUrl,_tmpDisplayTitle,_tmpCriticsPick,_tmpByline,_tmpHeadline,_tmpSummaryShort,_tmpPublicationDate,_tmpOpeningDate,_tmpLinkType,_tmpSuggestedLinkText,_tmpMultimediaType,_tmpMultimediaSrc,_tmpMultimediaWidth,_tmpMultimediaHeight,_tmpIsFavorite);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getFavoriteMovies(final int limit, final Continuation<? super List<DbMovie>> p1) {
    final String _sql = "SELECT * FROM movie WHERE is_favorite = 1 ORDER BY publication_date DESC LIMIT ?";
  ...
  @Override
  public Object getFavoriteMoviesCount(final Continuation<? super Integer> p0) {
    final String _sql = "SELECT COUNT(*) FROM movie WHERE is_favorite = 1";
  ...
  @Override
  public Object getMoviesCount(final String query, final Continuation<? super Integer> p1) {
    final String _sql = "SELECT COUNT(*) FROM movie WHERE display_title LIKE ? OR summary_short LIKE ?";
